...
# Tworzenie folderu benchmark, jeśli nie istnieje
...
for size in sizes:
    ...
    np.savetxt(f'{output_dir}/random_array_{size:08d}.txt', np.insert(random_array, 0, size), fmt='%d')
    np.savetxt(f'{output_dir}/increasing_array_{size:08d}.txt', np.insert(increasing_array, 0, size), fmt='%d')
    np.savetxt(f'{output_dir}/decreasing_array_{size:08d}.txt', np.insert(decreasing_array, 0, size), fmt='%d')
    np.savetxt(f'{output_dir}/constant_array_{size:08d}.txt', np.insert(constant_array, 0, size), fmt='%d')
    np.savetxt(f'{output_dir}/a_shaped_array_{size:08d}.txt', np.insert(a_shaped_array, 0, size), fmt='%d')
